...
document.querySelector('#app').innerHTML = `
  ...
  <main>
    ...
    <section class="contact section-shell" id="contact"><div class="contact-inner reveal"><p class="eyebrow">Get in touch</p><h2>Contact Raees for a free quote.</h2><p>Choose the quickest way to discuss your pool.</p><div class="contact-actions"><a class="button" href="${whatsappUrl}" target="_blank" rel="noreferrer">${icons.message}<span>WhatsApp</span></a><a class="button button-light" href="${phoneUrl}">${icons.phone}<span>065 143 1426</span></a></div></div></section>
  </main>
